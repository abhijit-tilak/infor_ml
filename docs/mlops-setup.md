...
git add README.md docs .gitignore infor_ml/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[infor_ml/databricks.yml](../infor_ml/databricks.yml) file.
...
Follow the instructions in [infor_ml/resources/README.md](../infor_ml/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../infor_ml/resources/README.md)  to propose, test, and deploy
