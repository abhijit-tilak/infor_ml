...
Opening a pull request will trigger a[workflow](../.github/workflows/infor_ml-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/infor_ml/infor_ml-model)
* [Prod model in UC](https://e2-demo-west.cloud.databricks.com/explore/data/models/prod/infor_ml/infor_ml-model)
. 
