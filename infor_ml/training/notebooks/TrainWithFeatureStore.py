...
# ``infor_ml/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.abhijit_tilak.infor_ml-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.abhijit_tilak.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.abhijit_tilak.trip_dropoff_features",
